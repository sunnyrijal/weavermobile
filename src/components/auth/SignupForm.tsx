...
import { signupUser, signInWithGoogle, signInWithApple } from "@/lib/actions/authActions";
...
export function SignupForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    if (result.success && result.user) {
      ...
      toast({ title: "Signup Successful", description: "Welcome to NetworkNest!" });
      router.push("/dashboard"); // Or an onboarding page
    } else {
      toast({
        title: "Signup Failed",
  ...
  return (
    <>
      <h2 className="text-2xl font-semibold text-center mb-6 text-foreground">Create an Account</h2>
      <Form {...form}>
