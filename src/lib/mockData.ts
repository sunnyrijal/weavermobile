...
export const mockContacts: Contact[] = [
  ...
  { id: "emily_g", ownerId: "user1", name: "Emily Grenecer", occupation: "Peace Corps Volunteer", locationDetails: "Portland, Maine", category: "Partner", tags: ["Partner", "Peace Corps"], createdAt: new Date(), updatedAt: new Date(), relationships: [{ relatedContactId: "4", type: "Partner" }], photosTogether: [], birthday: "1999-07-25" },
  { id: "alpine_d", ownerId: "user1", name: "Alpine", category: "Pet", tags: ["Dog", "Black Labrador"], createdAt: new Date(), updatedAt: new Date(), relationships: [{ relatedContactId: "4", type: "Owner" }], photosTogether: [] },
  { id: "shula_d", ownerId: "user1", name: "Shula", category: "Pet", tags: ["Dog", "Black Labrador"], createdAt: new Date(), updatedAt: new Date(), relationships: [{ relatedContactId: "4", type: "Owner" }], photosTogether: [] },
