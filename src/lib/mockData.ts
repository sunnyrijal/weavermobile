...
export const mockContacts: Contact[] = [
  // Chandra Oli
  {
    ...
    hometown: "Kritipur, Nepal",
    currentLocation: "Cincinnati, Ohio",
  ...
  // Abhas Oli
  {
    ...
    currentLocation: "Beloit, Wisconsin",
  ...
  // Dr. Emily Carter
  {
    ...
    currentLocation: "Stanford University",
  ...
  { 
    ...
    currentLocation: "Portland, Maine", 
    category: "Partner", 
    tags: ["Peace Corps"], 
  ...
  },
  {
    ...
    relationships: [
        { relatedContactId: "1", type: "Child", customLabel:"Son" }, 
        { relatedContactId: "ro_dad_co", type: "Partner", customLabel: "Wife"},
        { relatedContactId: "do_sis_co", type: "Child", customLabel: "Daughter"},
    ],
    createdAt: new Date(),
    updatedAt: new Date(),
